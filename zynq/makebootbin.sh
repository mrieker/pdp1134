#!/bin/bash
#
#  create the BOOT.BIN file for pdp1134
...
cd petakernl/zturn
if [ images/linux/BOOT.BIN -ot $mydir/pdp1134.runs/impl_1/myboard_wrapper.bit ]
then
    rm -f images/linux/BOOT.BIN
    petalinux-package --boot --force --fsbl ./images/linux/zynq_fsbl.elf --fpga $mydir/pdp1134.runs/impl_1/myboard_wrapper.bit --u-boot
fi
