...
# install RSTS/E V9.6 onto an RP04

#  ./z11gui &  (optional)
#  ./z11ctrl rsts96sysgen-rp04.tcl
...
probedevsandmem
pin set turbo 1 rh_fastio 1 tm_fastio 1

exec -ignorestderr ./z11xe -daemon
rhload 0 -create disks/rsts96/dbsys.rp04
tmload 0 -readonly disks/rststapes/rsts_v9_6_install.tap
tmload 1 -readonly disks/rststapes/rsts_v9_library.tap
tmboot
...
replytoprompt "Packages to install: " "ALL"
replytoprompt "Proceed? <yes> " ""
replytoprompt "Do you want the I&D versions of tasks? <no> " ""
replytoprompt "Use resident library version of RMS? <yes> " "NO"
replytoprompt "Use RMS resident libraries in DAP? <yes> " "NO"
replytoprompt "Use RMS resident libraries in PBS? <yes> " "NO"
replytoprompt "Use resident library version of EDT? <yes> " "NO"

waitforstring "Do you want to transfer the layered product update components"
replytoprompt "from the Installation kit? <yes> " ""
replytoprompt "Product updates to transfer: " "ALL"
replytoprompt "Proceed? <yes> " ""
...
replytoprompt "Library device? <_MT0:> " "_MT1:"
